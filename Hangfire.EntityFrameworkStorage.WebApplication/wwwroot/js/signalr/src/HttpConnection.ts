...
export class HttpConnection implements IConnection {
    ...
    private readonly _negotiateVersion = 1;
    ...
    private async _createTransport(url: string,
        ...
        for (const endpoint of transports) {
            const transportOrError =
                this._resolveTransportOrError(endpoint, requestedTransport, requestedTransferFormat);
            if (transportOrError instanceof Error) {
                ...
                try {
                    ...
                    negotiate = undefined;
                    transportExceptions.push(new FailedToStartTransportError(`${endpoint.transport} failed: ${ex}`,
        ...
        if (transportExceptions.length > 0) {
            return Promise.reject(new AggregateErrors(
    ...
    private _constructTransport(transport: HttpTransportType): ITransport {
        ...
        case HttpTransportType.WebSockets:
            ...
            return new WebSocketTransport(this._httpClient,
        ...
        case HttpTransportType.ServerSentEvents:
            ...
            return new ServerSentEventsTransport(this._httpClient,
                this._accessTokenFactory,
                this._logger,
                this._options);
    ...
    private _resolveTransportOrError(endpoint: IAvailableTransport,
        ...
        if (transport === null || transport === undefined) {
            ...
            if (transportMatches(requestedTransport, transport)) {
                ...
                return new DisabledTransportError(`'${HttpTransportType[transport]}' is disabled by the client.`,
                    transport);
            }
        }
    }
    ...
    private _stopConnection(error?: Error): void {
        ...
        if (this._connectionState === ConnectionState.Connecting) {
            ...
            throw new Error(
                `HttpConnection.stopConnection(${error
