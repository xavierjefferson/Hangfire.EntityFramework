...
namespace Hangfire.EntityFrameworkStorage
{
    public sealed class EntityFrameworkStorageFactory
    {
        ...
        public static EntityFrameworkJobStorage For(ProviderTypeEnum providerType, string nameOrConnectionString,
            EntityFrameworkStorageOptions options = null)
        {
            return new EntityFrameworkJobStorage(providerType, nameOrConnectionString,
